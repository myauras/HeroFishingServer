...
REM =======Build image=======
docker build --no-cache -f matchmaker/Dockerfile -t asia-east1-docker.pkg.dev/fourth-waters-410202/herofishing/herofishing-matchmaker:0.2.24 .
@if ERRORLEVEL 1 exit /b 1

REM =======Push image=======
docker push asia-east1-docker.pkg.dev/fourth-waters-410202/herofishing/herofishing-matchmaker:0.2.24
@if ERRORLEVEL 1 exit /b 1
