...
// 建立玩家資料
func CreatePlayerData(playerID string, point int64, ptBuffer int64, totalWin int64, totalExpenditure int64, heroExp int32, spellLV [3]int32, spellCharges [3]int32, drops [3]int32) (*RedisPlayer, error) {
