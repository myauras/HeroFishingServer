...
$content = [System.IO.File]::ReadAllText('Dev_DeleteAllCrontaskerAndKeepByVersion.ps1', $utf8WithoutBom)
...
if ($match.Success) {
    ...
    [System.IO.File]::WriteAllText('Dev_DeleteAllCrontaskerAndKeepByVersion.ps1', $content, $utf8WithoutBom)
