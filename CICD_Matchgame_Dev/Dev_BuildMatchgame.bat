...
REM =======Build image=======
docker build --no-cache -f matchgame/Dockerfile -t asia-east1-docker.pkg.dev/testgcpproject1-415003/herofishing/herofishing-matchgame:0.2.377 .
@if ERRORLEVEL 1 exit /b 1

REM =======Push image=======
docker push asia-east1-docker.pkg.dev/testgcpproject1-415003/herofishing/herofishing-matchgame:0.2.377
@if ERRORLEVEL 1 exit /b 1
